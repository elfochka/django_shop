...
Для запуска команды ежесуточно в 00:00:00, при деплое приложения на сервере предлагается использовать системный сервис 
Linux `cron`.
...
0 0 * * * python -m manage random_chosen_product
